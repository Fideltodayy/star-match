  ...
  return (
    <>
      ...
      <div className={`game ${showModal ? "modal-open" : ""}`}>
        <div className="flex justify-between items-center h-16 px-4 bg-slate-200 dark:bg-gray-800  rounded-full border-2 border-gray-600">
          <div>
        ...
        <div className="marquee-content">
          <span>
            For each random number of stars, pick 1 or more numbers that sum up
            to the given number of stars. If you pick more numbers than the
            count of stars, they will be marked as wrong in red. You can always
            unpick the candidates or wrong numbers to make the correct
            selection. Keep an eye on the timer! If it runs out and you haven't
            picked all the numbers, the game is over. Click "PLAY AGAIN" to
      ...
      <footer>
        <h6 style={{ fontFamily: "Kalam" }}>Made with</h6>
        {"\u2764"} <h6 style={{ fontFamily: "Kalam" }}>by </h6>

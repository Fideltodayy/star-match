  ...
  return (
    <>
      ...
      <div className={`game ${showModal ? "modal-open" : ""}`}>
        ...
        <div className="marquee-container" style={{ fontFamily: "Kalam" }}>
          ...
          <span className="marquee-content">Click "PLAY AGAIN" to start a new game at any time.</span className="marquee-content">
        </div>
        <div className="body">
          <div className="left">
            {gameStatus !== "active" ? (

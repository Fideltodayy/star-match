  ...
  return (
    <>
      ...
      <div className={`game ${showModal ? "modal-open" : ""}`}>
        <div className="flex justify-between items-center h-16 px-4 bg-gray-800  rounded-full border-2 border-gray-600">
          <div>
            <h2 className=" text-3xl" style={{font-family: 'Pacifico', cursive;}}>Star-Match</h2>
          </div>
          <div>
            {darkMode ? (
              <BsMoonStarsFill
              ...
              <BsSun onClick={toggleDarkMode} className="text-white text-2xl" />
            )}
          </div>
        </div>

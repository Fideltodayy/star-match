...
function StarMatch(props) {
  ...
  return (
    <>
      ...
      <div
        className={`game flex justify-center ${showModal ? "modal-open" : ""}`}
      >
        ...
        <div className="marquee-content" style={{ fontFamily: "Kalam" }}>
          ...
          <span>
            Keep an eye on the timer! If it runs out and you haven't picked all
            the numbers, the game is over.
          </span>{" "}
          <span>Click "PLAY AGAIN" to start a new game at any time.</span>
        </div>
        <div className="body ">
          <div className="left">
            {gameStatus !== "active" ? (

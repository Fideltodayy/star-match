      ...
      <div className={`game ${showModal ? "modal-open" : ""}`}>
        ...
        <div className="marquee-content" style={{ fontFamily: "Kalam" }}>
          <span>
            ...
            upto the given number of stars. If you pick more numbers than
            thecount of stars, they will be marked as wrong in red. You can
            alwaysunpick the candidates or wrong numbers to make the
            correctselection. Keep an eye on the timer! If it runs out and you
            haven'tpicked all the numbers, the game is over. Click "PLAY AGAIN"
            tostart a new game at any time.
          </span>
        </div>
        <div className="body">
          <div className="left">
